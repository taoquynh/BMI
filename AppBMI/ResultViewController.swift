...
class ResultViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let result = result {
            if result < 18.5 {
                ...
                commentLabel.text = "You have a malnourished body. Need more favors!"
            } else if result < 25 {
                statusLabel.text = "NORMAL"
                commentLabel.text = "You have a normal body weight. Good job!"
            } else if result < 30 {
                statusLabel.text = "OVERWEIGHT"
                commentLabel.text = "You have an overweight body. Need more exercise!"
            } else if result < 35 {
                statusLabel.text = "OBESE"
                commentLabel.text = "You have an obese body. Need more exercise and nutritional balance!"
            } else {
                statusLabel.text = "EXTREMELY OBESE"
                commentLabel.text = "You have an extremely obese body. Warning of health dangers."
            }
    ...
    func setupLayout(){
        ...
        reCalculatorButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -(bottomPadding + 2*margin)).isActive = true
